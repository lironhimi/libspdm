                                      ...
                                      size_t request_size, void *request)
{
    ...
    LIBSPDM_DEBUG((LIBSPDM_DEBUG_INFO, "libspdm_send_spdm_request[%x] msg %s(0x%x), size (0x%x): \n",
                                          ...
                                          void **response)
{
    ...
    *response_size = scratch_buffer_size - transport_header_size;
    ...
    LIBSPDM_DEBUG((LIBSPDM_DEBUG_INFO, "libspdm_receive_spdm_response[%x] msg %s(0x%x), size (0x%x): \n",
                   (session_id != NULL) ? *session_id : 0x0,
